...
const backgrounds = [
  { name: 'City', url: 'url("/src/assets/Backgrounds/City.png")' },
  { name: 'Green', url: 'url("/src/assets/Backgrounds/Green.png")' },
  { name: 'Pokeball', url: 'url("/src/assets/Backgrounds/PokeballBG.png")' },
];
